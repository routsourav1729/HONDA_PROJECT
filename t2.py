...
optim_wrapper = dict(
    ...
    optimizer=dict(
        batch_size_per_gpu=8, lr=0.0001, type='AdamW', weight_decay=0.0125),
    paramwise_cfg=dict(
        bias_decay_mult=0.0,
        custom_keys=dict({
...
test_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='ImageSets/Main/IDD/test.txt',
        batch_shapes_cfg=None,
...
trlder = dict(
    batch_size=16,
    dataset=dict(
        ann_file='ImageSets/Main/IDD/t2_30shot.txt',
        ann_subdir='FewShot_Annotations/30shot',
        batch_shapes_cfg=None,
        data_prefix=dict(sub_data_root=''),
        data_root='./datasets',
        metainfo=dict(
