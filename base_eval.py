...
if __name__ == "__main__":
    ...
    cfgY.work_dir = "."
    # Load trained checkpoint instead of pretrain weights for evaluation
    trained_checkpoint = os.path.join(args.task, "model_latest.pth")
    if os.path.exists(trained_checkpoint):
        cfgY.load_from = trained_checkpoint
        ...
        print(f"Warning: Trained checkpoint not found, using pretrain weights")
