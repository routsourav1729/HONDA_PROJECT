...
def load_ckpt(model, checkpoint_path, prev_classes, current_classes, eval = False):
    ...
    # 1. Original format: state_dict saved directly
    # 2. New format: {'model_state_dict': state_dict, 'epoch': ..., 'optimizer_state_dict': ...}
...
class CustomYoloWorld(nn.Module):
    ...
    def contrastive_loss(self,
        ...
        if len(contrastive_losses) == 0:
            return flatten_scores_list.new_tensor(0.0)
